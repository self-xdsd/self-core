 ...
 * @since 0.0.1
 */
final public class GitlabTestCase {
    ...
    public void fetchesRepoOk() {
        ...
        assertThat(jsonRepo.getString("path_with_namespace"), equalTo("criske/test2"));
    }
    ...
    /**
     * Creates a Gitlab instance based on a mocked {@link com.selfxdsd.api.User}
     *
    ...
    private Gitlab createGitlab(final String username) {
        ...
        when(user.provider()).then(invocation -> new Gitlab((User) invocation.getMock(), null));
