...
/**
 * Unit tests for {@link GitlabOrganizations}.
 *
 * @author criske
 * @version $Id$
 * @since 0.0.9
 */
public final class GitlabOrganizationsTestCase {
    ...
    public void fetchesOk() {
        ...
        final Iterable<Organization> organizations =
            () -> new GitlabOrganizations(resources,
    ...
    public void throwsWhenUnableToFetch() {
        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("Unable to fetch Gitlab "
